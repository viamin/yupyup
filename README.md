...
It does not yet implement actors, a full structural type checker, formal verification, multiline `do ... end` blocks, collections, general method-call dot syntax, mutable record updates, record destructure patterns in `match`, short-circuit boolean operators in the BEAM backend, or string interpolation.
